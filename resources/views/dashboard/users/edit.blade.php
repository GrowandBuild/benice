        ...
        <div class="bg-gradient-to-r from-blue-600 via-indigo-500 to-purple-500 shadow-lg">
            <div class="max-w-4xl mx-auto px-6 py-8">
                <div class="flex items-center">
                    ...
                    <div>
                        <h1 class="text-4xl font-bold text-white mb-1">Editar Usuário</h1>
                        <p class="text-blue-100 text-lg">Ajuste as informações e permissões de {{ $user->name }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8 border border-blue-100">
                <form action="{{ route('dashboard.users.update', $user) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <!-- Password -->
                        <div>
                            <label for="password" class="block text-lg font-semibold text-gray-700 mb-2">Nova Senha (Opcional)</label>
